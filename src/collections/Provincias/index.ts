...
import { revalidateDeleteProvincia, revalidateProvincia } from './hooks/revalidateProvincia'
...
export const Provincias: CollectionConfig<'provincias'> = {
  slug: 'provincias',
  access: {
  ...
  // This config controls what's populated by default when a provincia is referenced
  // https://payloadcms.com/docs/queries/select#defaultpopulate-collection-config-property
  // Type safe if the collection slug generic is passed to `CollectionConfig` - `CollectionConfig<'provincias'>
  defaultPopulate: {
    title: true,
    slug: true,
  },
  ...
  hooks: {
    afterChange: [revalidateProvincia],
    beforeChange: [populatePublishedAt],
    afterDelete: [revalidateDeleteProvincia],
  },
  versions: {
    drafts: {
      autosave: {
