...
export const Card: React.FC<{
  ...
  return (
    <article
      className={cn(
        'relative border border-border rounded-xl overflow-hidden hover:cursor-pointer hover:scale-105 transition-all duration-300 bg-transparent hover:bg-white',
        className,
      )}
      ref={card.ref}
    >
